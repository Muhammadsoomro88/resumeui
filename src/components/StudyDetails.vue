...
<div class="container">
    ...
    <form @submit="onSubmit" class="add-form">
        <a @click="incrementIteration">+add education</a>
        <br>
        <div v-for="num in iterate" :key="num">
            <div class="inp">
                <input type="text" v-model="program" name="program" placeholder="Enter Degree Program*">
            </div>
            <div class="inp">
            ...
            <div class="inp">
                <input type="text" v-model="institution" name="institution" placeholder="Enter Institution Name*">
            </div>
            <div class="inp">
                <textarea name="summary" v-model="summary" id="summary" cols="54" rows="05" placeholder="Enter education details*"></textarea>
            </div>
            <div v-if="isError">
...
export default {
    ...
    methods:{
        incrementIteration(){
            ...
            this.studyDetails.push(createdEmp)
        },
        onSubmit(e){
            e.preventDefault()
            if (this.present) {
            ...
            if (this.program === '' || this.start === '' || this.end === '' || this.institution === '' || this.summary === ''){
                this.isError = true
            ...
            this.submitted = true
            this.$emit('study-details', this.studyDetails)
        }
    }
}
</script>
